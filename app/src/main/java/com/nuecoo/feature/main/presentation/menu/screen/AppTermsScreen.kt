    ...
    Column(
        ...
        Row(
            ...
            MainTitleItem(
                ...
                subTitle = stringResource(R.string.text_app_terms_sub_title),
                mainTitle = stringResource(R.string.text_app_info_terms_title)
            )
        }

        DefaultItemBox(modifier = Modifier.padding(top = 24.dp, bottom = 24.dp)) {
            Text(
                text = stringResource(R.string.text_app_terms_content),
                color = SubText,
                fontSize = 14.sp,
                lineHeight = 22.sp,
