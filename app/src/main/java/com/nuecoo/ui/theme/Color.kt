...
val TimerBackground = Color(0x884D310E)
...
val ProfileBackground = Color(0xFFF2D8B2)
...
val AttendanceActive = Color(0xFFFBE6CF)
val AttendanceInActive = Color(0xFFECE0C8)
val AttendanceComplete = Color(0xFFe0750f)
